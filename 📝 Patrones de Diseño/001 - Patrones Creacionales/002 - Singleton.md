# Singleton
El patrón Singleton es un patrón creacional que asegura que una clase tenga una única instancia y proporciona un punto de acceso global a ella. Este patrón es útil cuando se necesita controlar el acceso a recursos compartidos, como configuraciones, conexiones a bases de datos o registros de logging.
