...
- **Delimitación de estructuras**: Las estructuras (como clases, métodos, y bloques) deben ser delimitadas con llaves (`{}`).
- **Paso de parámetros**: Los parámetros de los métodos deben ir entre paréntesis (`()`).