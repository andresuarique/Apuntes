...
Desarrollo guiado por [pruebas](001%20-%20Testing.md). En esta metodología, se crean primero las pruebas antes de escribir el código. Es decir, se definen las expectativas (expect) antes de implementar la funcionalidad.
