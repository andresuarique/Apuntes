...
En Express.js, el [routing](Routing%20en%20Aplicaciones%20Web.md) se implementa mediante el uso de [métodos de solicitud HTTP](Métodos%20HTTP.md) para definir cómo la aplicación responde a las solicitudes de los clientes en puntos finales específicos. A continuación, se muestra cómo se aplica el routing en Express:
...
3. **Middleware de Rutas:**
   - Express permite utilizar [middleware](Middleware.md) de rutas para realizar acciones específicas antes o después de que se ejecute el manejador de la ruta. Esto proporciona flexibilidad para agregar funcionalidades adicionales a las rutas, como la autenticación, la validación de datos, el registro de solicitudes, etc.
