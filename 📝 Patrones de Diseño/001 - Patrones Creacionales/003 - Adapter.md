# Adapter
El patrón Adapter es un patrón estructural que permite que dos interfaces incompatibles trabajen juntas. Este patrón actúa como un puente entre las interfaces, adaptando una interfaz existente a la que se espera.
