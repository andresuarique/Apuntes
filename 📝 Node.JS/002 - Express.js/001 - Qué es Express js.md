...
1. **Manejadores de Peticiones**:
   - Permite la escritura de manejadores de peticiones utilizando diferentes [verbos HTTP](Métodos%20HTTP.md) (GET, POST, PUT, DELETE, etc.) en diferentes caminos URL (rutas).
...
4. **Middleware**:
   - Añade procesamiento de peticiones "[middleware](Middleware.md)" adicional en cualquier punto dentro de la tubería de manejo de la petición. Esto permite la manipulación de solicitudes y respuestas, la adición de funcionalidades y el manejo de errores de manera modular y flexible.
